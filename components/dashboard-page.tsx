    ...
    <div className="p-6">
      ...
      <Tabs defaultValue="transactions" className="mb-6">
        ...
        <TabsContent value="tokens">
          <div className="text-center py-12 text-gray-500">Token information will be displayed here</div>
        </TabsContent>

        <TabsContent value="investment">
          <div className="text-center py-12 text-gray-500">Investment information will be displayed here</div>
        </TabsContent>
      </Tabs>
    </div>
  )
